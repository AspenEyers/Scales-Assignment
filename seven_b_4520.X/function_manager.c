...
char count_intro_msg[] = "Count mode entered: \n\r";
char set_grams_intro_msg[] = "Measurements to grams\n\r";
char set_ounces_intro_msg[] = "Measurements to ounces\n\r";
char factory_intro_msg[] = "Factory mode\r\n";
char weight_readings_intro_msg[] = "Weight readings\r\n";
char statistics_intro_msg[] = "Weight statistics\r\n";
char samples_intro_msg[] = "Set samples number\r\n";
char msg2[] = "default";
char end_msg2[] = "\r\n";
